...
export class NgMultiselectDropdownComponent {
    public _settings!: IDropdownSettings;
    public _data: Array<ListItem> = [];
    public selectedItems: Array<ListItem> = [];
    public isDropdownOpen = true;
    _placeholder = 'Select';
    private _sourceDataType: string | null = null; // to keep note of the source data type. could be array of string/number/object
    ...
    @ContentChild('optionsTemplate') optionsTemplateRef: TemplateRef<any> | null = null;
    @ContentChild('optionSelectedTemplate') optionSelectedTemplateRef: TemplateRef<any> | null = null;

    @Output('onFilterChange') onFilterChange: EventEmitter<ListItem> = new EventEmitter<ListItem>();
    @Output('onDropDownClose') onDropDownClose: EventEmitter<ListItem> = new EventEmitter<ListItem>();

    @Output('onSelect') onSelect: EventEmitter<ListItem> = new EventEmitter<ListItem>();

    @Output('onDeSelect') onDeSelect: EventEmitter<ListItem> = new EventEmitter<ListItem>();
